...
const PrivacyPolicy = () => {
    ...
    // Yaha sara DOC ka content string me rakh lo
    const termsContent = `
QBIDnow.com ('we' or 'us' or 'our') respects the privacy of our users ('user' or 'you'). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the 'App') or our website qbidnow.com, qbid, qbidnow (collectively, the 'Site'). Please read this Privacy Policy carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS THE APP. 
...
We may collect information about you in a variety of ways. The information we may collect via the App, WEBSITE, depends on the content and materials you use, and includes: 
Personal Data We collect and store all personal information related to your App profile, which you voluntarily give us either upon sign-up or through continued use of the App: 
● First and last name 
● Nickname
● Home Address & State
● Zip-code 
...
Derivative Data and Uploaded Media 
...
● To improve our website and product (we continually strive to improve QBIDnow and the website based on your feedback) 
● We may periodically send promotional emails about new products, special offers or other information which we think you may find interesting using the email address which you have provided. We will also require you to link either your iTunes Account, ApplePay Account or Google Play Account with our App if you wish to purchase one of our Premium subscriptions. This does not give us access to your credit card or banking information, but is needed so that we can process your purchases/subscriptions. 

DISCLOSURE OF YOUR INFORMATION 

We may share information we have collected about you in certain situations. Your information may be disclosed as follows: 
We will not sell, distribute, or lease your personal information to unrelated third parties unless we have your permission or are required by law to do so. We may need to send your personal information to our third-party vendors, who are under contractual obligations to keep this information confidential. We may also use your personal information to send you promotional information about third parties which we think you may find interesting if you tell us that you wish this to happen. Finally, if we ever sell QBIDnow.com LLC, or participate in a merger or consolidation, and our User data is one of the assets involved in the sale, your personal information will be part of this sale or transfer. 
We may also disclose your personal information: 
● To comply with any court order, law or legal process, including to respond to any government or regulatory request. 
● To enforce or apply our Terms of Use and other agreements, including for billing and collection purposes. 
● If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of QBIDnow.com LLC, our customers, or others. This may include exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction. 
...
Account Information You can review and change your personal information by logging into your profile through the website or App and visiting your account profile page or settings page. You may also send us an email thru our website www.qbidnow.com or thru the APP in contact us, to request access to, correct or delete any personal information that you have provided to us. We may not be able to delete your personal information except by also deleting your user account. We also may not accommodate a request to change information if we believe the change would violate any law or legal requirement, or cause the information to be incorrect. Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, some information may be retained in our files to prevent fraud, troubleshoot problems, assist with any investigations, enforce our Terms of Use and/or comply with legal requirements. When we receive a termination or deletion request, all data that is deemed non-critical to the cases outlined above, will be retained at most 30 days in which period we will ensure complete deletion of such data from all databases and backups. 
...
● Clicking the opt-out button at the bottom of any promotional email you receive. If you no longer wish to receive correspondence, emails, or other communications from third parties, you are responsible for contacting the third party directly. 
...
YOUR CONSENT 
By using our site or app, you consent to our privacy policy. CONTACT US If you have questions or comments about this Privacy Policy, please contact us at: www.QBIDnow.com 5900 Balcones Drive Austin TX 78731 www.QBIDnow.com 
`;
